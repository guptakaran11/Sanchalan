...
class ProfileDataModel {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'activateRideRequestID': activateRideRequestID,
  ...
  factory ProfileDataModel.fromMap(Map<String, dynamic> map) {
    return ProfileDataModel(
      ...
      registeredDateTime: map['registeredDateTime'] != null
          ...
          : null,
      activateRideRequestID: map['activateRideRequestID'] != null
          ? map['activateRideRequestID'] as String
          : null,
      driverStatus:
