...
import 'package:sanchalan/rider/controller/services/nearByDriverServices/nearByDriverServices.dart';
import 'package:sanchalan/rider/controller/services/rideRequestServices/rideRequestServices.dart';
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color:
                                index == selectedCarType ? black : transparent,
                            width: 2,
                          ),
                        ),
                        child: Row(
